var U = {
    ...
    strReverseFromUntil: function(str,rightIndex,exp){var rev='';for(var i=str.length-1;i>=0;i--){rev+=str[i];}rev=rev.substring(rightIndex);var arr=rev.split(exp);return(Array.isArray(arr)&&arr[0])?arr[0]:'';},
