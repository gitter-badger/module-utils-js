var U = {
    ...
    map: function(arr,fn){var arr=[];for(var i=0;i<this.length;i++){arr.push(fn(arr[i],i,arr));}return arr;},
    ...
    domAddClass: function(sel,v){if(!v||typeof(v)!=='string'){return new Error('invalidParameter');}var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}if(Array.isArray(els)){var len=els.length;for(var i=0;i<len;i++){var el=els[i];if(!el){continue;}var clas=v.split(/\s+/);var lenlen=clas.length;for(var j=0;j<lenlen;j++){var cla=clas[j];addClass(el,cla);}}}function addClass(el,v){if(el.classList){el.classList.add(v);}else{el.className+=' '+v;}}},
    ...
    domToggleClass: function(sel,v){if(!v||typeof(v)!=='string'){return new Error('invalidParameter');}var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}if(Array.isArray(els)){var len=els.length;for(var i=0;i<len;i++){var el=els[i];if(!el){continue;}var clas=v.split(/\s+/);var lenlen=clas.length;for(var j=0;j<lenlen;j++){var cla=clas[j];toggleClass(el,cla);}}}function toggleClass(el,v){el.classList.toggle(v);}},
    domVal: function(sel,v){if(v&&typeof(v)!=='string'&&isNaN(v)){return new Error('invalidParameter');}var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}var arr=[];if(Array.isArray(els)){for(var i=0;i<els.length;i++){var el=els[i];if(!el){continue;}if(v===undefined){arr.push(getVal(el));}else{setVal(el,v);}}}return selectingOne(sel)?arr[0]:arr;function getVal(el){return el.value||null;}function setVal(el,v){if(v===undefined){return el.value;}else{el.value=v;}}function selectingOne(sel){var parts=sel.split(/\s+/);return(parts&&parts.length==1&&parts[0][0]=='#');}},
    domAttr: function(sel,k,v){if(!k||typeof(k)!=='string'){throw new Error('invalidParameter');}if(v&&typeof(v)!=='string'&&isNaN(v)&&typeof(v)!==null){throw new Error('invalidParameter')}var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}var arr=[];if(Array.isArray(els)){for(var i=0;i<els.length;i++){var el=els[i];if(!el){continue;}if(v===undefined){arr.push(getAttr(el,k));}else{setAttr(el,k,v);}}}return selectingOne(sel)?arr[0]:arr;function getAttr(el,k){return el.getAttribute(k)||null;}function setAttr(el,k,v){el.setAttribute(k,v);}function selectingOne(sel){var parts=sel.split(/\s+/);return(parts&&parts.length==1&&parts[0][0]=='#');}},
    domData: function(sel,k,v){if(!k||typeof(k)!=='string'){throw new Error('invalidParameter');}try{v=normalizeVal(v);}catch(err){throw new Error('unableToParse');}var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}var arr=[];if(Array.isArray(els)){for(var i=0;i<els.length;i++){var el=els[i];if(!el){continue;}if(v===undefined){arr.push(getData(el,k));}else{setData(el,k,v);}}}return selectingOne(sel)?arr[0]:arr;function getData(el,k){return el.dataset[k]||null;}function setData(el,k,v){el.dataset[k]=v;}function normalizeVal(v){if(v===undefined){return undefined;}else if(typeof(v)==='string'){return v;}else if(typeof(v)==='object'){if(!v){return null;}try{return JSON.stringify(v);}catch(err){throw new Error('invalidParameter');}}else if(v&&typeof(v.toString)=='function'){return v.toString();}else{throw new Error('invalidParameter');}}function selectingOne(sel){var parts=sel.split(/\s+/);return(parts&&parts.length==1&&parts[0][0]=='#');}},
    domHtml: function(sel,v){if(v&&typeof(v)!=='string'){return new Error('invalidParameter');}var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}var arr=[];if(Array.isArray(els)){for(var i=0;i<els.length;i++){var el=els[i];if(!el){continue;}if(v===undefined){arr.push(getHtml(el));}else{setHtml(el,v);}}}return selectingOne(sel)?arr[0]:arr;function getHtml(el){return el.innerHTML||null;}function setHtml(el,v){el.innerHTML=v;}function selectingOne(sel){var parts=sel.split(/\s+/);return(parts&&parts.length==1&&parts[0][0]=='#');}},
    domText: function(sel,v){if(v&&typeof(v)!=='string'){return new Error('invalidParameter');}var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}var arr=[];if(Array.isArray(els)){for(var i=0;i<arr.length;i++){var el=arr[i];if(!el){continue;}if(v===undefined){arr.push(getText(el));}else{setText(el,v);}}}return selectingOne(sel)?arr[0]:arr;function getText(el){return el.textContent||null;}function setText(el,v){el.textContent=v;}function selectingOne(sel){var parts=sel.split(/\s+/);return(parts&&parts.length==1&&parts[0][0]=='#');}},
    domParent: function(sel){var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}var arr=[];if(Array.isArray(els)){for(var i=0;i<arr.length;i++){var el=arr[i];if(el){arr.push(getParent(el));}}}return selectingOne(sel)?arr[0]:arr;function getParent(el){return el.parentNode||null;}function selectingOne(sel){var parts=sel.split(/\s+/);return(parts&&parts.length==1&&parts[0][0]=='#');}},
    domChildren: function(sel){var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}var arr=[];if(Array.isArray(els)){for(var i=0;i<els.length;i++){var el=els[i];if(el){arr.push(getChildren(el));}}}return selectingOne(sel)?arr[0]:arr;function getChildren(el){var els=el.children||[];var arr=[];for(var i=0;i<els.length;i++){arr[i]=els[i];}return arr;}function selectingOne(sel){var parts=sel.split(/\s+/);return(parts&&parts.length==1&&parts[0][0]=='#');}},
    domSiblings: function(sel){var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}var arr=[];if(Array.isArray(els)){for(var i=0;i<arr.length;i++){var el=arr[i];if(el){arr.push(getSiblings(el));}}}return selectingOne(sel)?arr[0]:arr;function getSiblings(el){var els=(el.parentNode&&el.parentNode.children)?el.parentNode.children:[];var arr=[];for(var i=0;i<els.length;i++){var ch=els[i];if(ch!==el){arr.push(ch);}}return arr;}},
    domStyle: function(sel,k,v){if(!k||typeof(k)!=='string'){throw new Error('invalidParameter');}if(v&&typeof(v)!=='string'){throw new Error('invalidParameter');}var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}var arr=[];if(Array.isArray(els)){for(var i=0;i<els.length;i++){var el=els[i];if(!el){continue;}if(v===undefined){arr.push(getStyle(el,k));}else{setStyle(el,k,v);}}}return selectingOne(sel)?arr[0]:arr;function getStyle(el,k){return el.style[k]||null;}function setStyle(el,k,v){el.style[k]=v;}function selectingOne(sel){var parts=sel.split(/\s+/);return(parts&&parts.length==1&&parts[0][0]=='#');}},
    domFadeIn: function(sel,t){var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}if(Array.isArray(els)){for(var i=0;i<els.length;i++){var el=els[i];if(el){fadeIn(el,t);}}}function fadeIn(el,t){el.style.transition='opacity '+(t&&!isNaN(t)&&t>0?t:250)+'ms';el.style.opacity='0';}function selectingOne(sel){var parts=sel.split(/\s+/);return(parts&&parts.length==1&&parts[0][0]=='#');}},
    domFadeOut: function(el,t){var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}if(Array.isArray(els)){for(var i=0;i<els.length;i++){var el=els[i];if(el){fadeOut(el,t);}}}function fadeOut(el,t){el.style.transition='opacity '+(t&&!isNaN(t)&&t>0?t:250)+'ms';el.style.opacity='1';}},
    domFadeTo: function(sel,o,t){if(!o||isNaN(o)||o>100||o<0){throw new Error('invalidParameter');}var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}if(Array.isArray(els)){var len=els.length;for(var i=0;i<els.length;i++){var el=els[i];if(el){fadeTo(el,o,t);}}}function fadeTo(el,o,t){el.style.transition='opacity '+(t&&!isNaN(t)&&t>0?t:250)+'ms';el.style.opacity=o.toString();}},
    domFadeToggle: function(sel,t){var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}if(Array.isArray(els)){var len=els.length;for(var i=0;i<els.length;i++){var el=els[i];if(el){fadeToggle(el);}}}function fadeToggle(el){el.style.transition='opacity '+(t&&!isNaN(t)&&t>0?t:250)+'ms';var s=el.ownerDocument.defaultView.getComputedStyle(el,null);var o=(!s)?null:s.opacity;if(o===null){return;}if(o==='1'){el.style.opacity='0';}else{el.style.opacity='1';}}},
    domOn: function(sel,k,fn){if(!k||typeof(k)!=='string'||typeof(fn)!=='function'){return new Error('invalidParameter');}var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}if(Array.isArray(els)){var len=els.length;for(var i=0;i<len;i++){var el=els[i];if(el){addListener(el,k,fn);}}}function addListener(el,k,fn){if(!U.__domInternal.handler[el]){U.__domInternal.handler[el]={};}if(!U.__domInternal.handler[el][k]){U.__domInternal.handler[el][k]=[];}U.__domInternal.handler[el][k].push(fn);el.addEventListener(k,fn,false);}},
    domOff: function(sel,k){if(k&&typeof(k)!=='string'){throw new Error('invalidParameter');}var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}if(Array.isArray(els)){var len=els.length;for(var i=0;i<len;i++){var el=els[i];if(el){removeListener(el,k||null);}}}function removeListener(el,k){if(!U.__domInternal.handler[el]){return;}if(k&&U.__domInternal.handler[el][k]){var fns=U.__domInternal.handler[el][k];var len=fns.length;for(var i=0;i<len;i++){var fn=fns[i];el.removeEventListener(k,fn,false);}}else{var sub=el.cloneNode(true);el.parentNode.replaceChild(sub,el);}}},
    domTriggerNativeEvent: function(sel,k){if(!k||typeof(k)!=='string'){throw new Error('invalidParameter');}var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}if(Array.isArray(els)){var len=els.length;for(var i=0;i<len;i++){var el=els[i];if(el){triggerEvent(el,k);}}}function triggerEvent(el,k){var e=document.createEvent('HTMLEvents');e.initEvent(k,true,false);el.dispatchEvent(e);}},
    domTriggerEvent: function(sel,k,v){if(!k||typeof(k)!=='string'){throw new Error('invalidParameter');}var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}if(Array.isArray(els)){var len=els.length;for(var i=0;i<len;i++){var el=els[i];if(el){triggerEvent(el,k,v)}}}function triggerEvent(el,k,v){var e=null;if(window.CustomEvent){e=new CustomEvent(k,{detail:v});}else{e=document.createEvent('CustomEvent');e.initCustomEvent(k,true,true,v);}el.dispatchEvent(e);}},
    domAppend: function(sel,v){if(typeof(v)!=='string'){throw new Error('invalidParameter');}var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}if(Array.isArray(els)){for(var i=0;i<els.length;i++){var el=els[i];if(el){domAppend(el,v);}}}function domAppend(el,v){el.insertAdjacentHTML('beforeend',v);}},
    domPrepend: function(sel,v){if(typeof(v)!=='string'){throw new Error('invalidParameter');}var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}if(Array.isArray(els)){for(var i=0;i<els.length;i++){var el=els[i];if(el){domPrepend(el,v);}}}function domPrepend(el,v){el.insertAdjacentHTML('afterbegin',v);}},
    domRemove: function(sel){var els=null;if(Array.isArray(sel)){els=sel;}else if(U.isDomEl(sel)){els=[sel];}else{els=Array.isArray(U.domFind(sel))?els:[els];}if(Array.isArray(els)){for(var i=0;i<els.length;i++){var el=els[i];if(el){domRemove(el);}}}function domRemove(el){el.parentNode.removeChild(el);}},
}
