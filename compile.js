...
compileUtils(process.env.NAMESPACE || 'YourModuleName');
function compileUtils(namespace) {
	str = 'var ' + namespace + ' = {\n';
	str += compileUtilsFromFile('./utils/base.js', namespace);
	str += compileUtilsFromFile('./utils/flow.js', namespace);
	str += compileUtilsFromFile('./utils/ajax.js', namespace);
	str += '}\n';
